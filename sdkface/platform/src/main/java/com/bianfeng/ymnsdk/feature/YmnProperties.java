...
import com.bianfeng.ymnsdk.util.DecodeUtil;
...
public class YmnProperties extends Properties {
    ...
    private static final String[][] NAMES = {{"appid", "appId", "appID", "AppId", "Appid", "app_id",}, {"appkey", "appKey", "AppKey", "Appkey", "app_key",}, {"secretkey", "secretKey", "Secretkey", "SecretKey", "secret_key",

            "appsecret", "appSecret", "Appsecret", "AppSecret", "app_secret",}, {"platPublicKey", "publicRsaKey", "publickey", "publicKey", "public_key",}, {"privateKey", "privatekey", "appPrivateKey", "private_key",}, {"payid", "payId", "pay_id",}, {"cpid", "cpId", "cp_id",}, {"gameid", "gameId", "game_id",},};
