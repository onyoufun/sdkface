...
public class YmnURLManager {
	...
	public static final String URL_HOST_PUBLIC_V1 = "";
	public static final String URL_HOST_PUBLIC_V2 = "";
	public static final String URL_HOST_TEST = "";

	public static final String URL_HOTFIX_PUBLIC = "";
	public static final String URL_HOTFIX_TEST = "";
